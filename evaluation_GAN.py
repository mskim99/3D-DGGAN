...
for i in range (0, 18):
    fake_volume = np.load('./comparison/230314_1_log_E_no_norm_lr_2e_6_G_D_recon_no_IoU_cont_epoch_410_input_rate_c_n_1_1_WGAN_GP_3_RMSprop_lambda_1e_4_code_noise_random_batch_size_4_liver/epoch_200_fake_V_' + str(i).zfill(2) + '.npy')
